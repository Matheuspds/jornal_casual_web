     ...
     <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Raimundo
                        <strong>Matheus</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    <h2>Bem Vindo ao Jornal Casual
                        <br>
                        <small>12 de Julho, 2016</small>
                    </h2>
                    <p> 
                    ...
                    <br>
                    Para ter acesso ao Jornal, cadastre-se.
                    <br>
                    Entre e faça login com os dados que você preencheu o cadastro e fique por dentro de notícias interessantes
                    </p>
                    <hr>
                </div>
            </div>
