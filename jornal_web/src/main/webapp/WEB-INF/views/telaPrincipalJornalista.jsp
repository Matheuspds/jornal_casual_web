        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="inserirNoticiaFormulario">Inserir Noticia</a>
                    </li>
                    <li>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <a href="listarNoticias"> <h3>Listar Noticias</h3> </a>
...
<!--  	
		...
		<a href="inserirNoticiaFormulario"> <b>Inserir Noticia</b></a>
		...
		<c:if test="${usuario_logado.login == noticia.usuario.login}">
			<c:if test="${noticia.ativa}">
				<tr>
					...
					<td><a href="desabilitarNoticia?id=${noticia.id}">APAGAR</a></td>
				</tr>
			</c:if>
		</c:if>
	</c:forEach>
